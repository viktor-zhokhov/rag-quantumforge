...
- **Скриншоты/логи:** `screenshots/` (10 обращений: 5 успешных + 5 отказ/фильтр).
- **Выводы:** _(заполнить после прогона: где ответ был корректным, где без защиты происходила утечка)_
