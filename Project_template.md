...
- **Результат:** ~2950 замен, ни одного узнаваемого термина Star Wars в финальной базе (проверено grep-ом по содержимому и по именам файлов). Также отфильтрованы служебные плашки вики и списки-источники.
